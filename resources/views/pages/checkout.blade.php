...
@section('title', 'Checkout Travel | NOMADS ID')
...
<main>
                    ...
                    <div class="card card-details">
                                    ...
                                    <tr class="customer_row">
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('checkout-remove', $detail->id)}}">
                                                <img src="{{ url('/frontend/frontend/images/ic_remove.png')}}" alt="" width="20"
                                                height="20" />
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                ...
                                <input type="text" class="form-control mb-2 mr-sm-2" name="nationality" id="inputNationality" style="width: 50px" required
                                placeholder="Nationality" />
                                
                                <label for="is_visa" class="sr-only">VISA</label>
                                <select name="is_visa" id="inputVisa" required
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                <input type="text" class="form-control datepicker" id="doePassport" name="doe_passport" style="width: 130px"
                ...
                <div class="card card-details card-right">
                    ...
                    <div class="bank">
                        <div class="bank-item pb-3">
                            <img src="{{url('/frontend/frontend/images/ic_bank.png')}}" alt="" class="bank-image" />
                            <div class="description">
                                <h3>PT Nomads ID</h3>
                                <p>Bank Central Asia<br>0829 0999 8390</p>
                            </div>
                            ...
                            <div class="bank-item pb-3">
                                ...
                                <div class="description">
                                    <h3>PT Nomads ID</h3>
                                    <p>Bank HSBC<br>1111 2208 1996</p>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
    ...
    @push('prepend-style')
    <link rel="stylesheet" href="{{ url('/frontend/frontend/libraries/gijgo/css/gijgo.min.css')}}" />
    @endpush
    
    @push('addon-script')
    <script src="{{ url('/frontend/frontend/libraries/gijgo/js/gijgo.min.js')}}"></script>
    <script>
        $(document).ready(function () {
            ...
            $(".datepicker").datepicker({
                ...
                icons: {
                    rightIcon: '<img src="{{ url('/frontend/frontend/images/ic_doe.png')}}" class"text-center">'
                }
            });
        });
    </script>
